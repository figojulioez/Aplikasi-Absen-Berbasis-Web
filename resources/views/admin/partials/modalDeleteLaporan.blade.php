      ...
      <div class="">
        ...
        <div class="text-center p-5 flex-auto justify-center mt-2">
          ...
          <h2 class="text-xl font-bold py-4">Apakah anda yakin?</h3>
            <p class="text-sm text-gray-500 px-8">Apakah anda benar-benar yakin menghapus item ini?</p>    
        </div>
        <!--footer-->
...
<script type="text/javascript">
    ...
    $('.btnDelete').on('click', function () {
        ...
        document.getElementById('formHapus').setAttribute('action', '/data-laporan/' + idk);
        document.getElementById('tgl').value = document.querySelector('input[type=date]').value;
